...
@InputType()
class AssignmentCreateNestedManyWithoutNegotiationsInput {
...
export { AssignmentCreateNestedManyWithoutNegotiationsInput as AssignmentCreateNestedManyWithoutNegotiationsInput };
